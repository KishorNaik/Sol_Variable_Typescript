...
let numValue = 20; // Valid Javascript
console.log(numValue);

//numValue = "Hello Javascritp"; // Compile Time Error // Type Inferance
//console.log(numValue);

let numValueTypescript: number; // typescript
